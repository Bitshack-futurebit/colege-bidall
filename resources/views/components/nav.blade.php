        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:ml-8 sm:flex sm:space-x-6">
                    ...
                    <a href="{{ route('communities.index') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium {{ request()->is('communities') || request()->is('community*') ? 'text-teal-600 dark:text-teal-400 border-b-2 border-teal-600' : 'text-gray-700 dark:text-gray-300 hover:text-teal-600' }}">Communities</a>
                    @endif
                </div>
            </div>
...
<nav class="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700"
    ...
    <div class="grid grid-cols-4 h-16">
        ...
        {{-- Communities --}}
        <a href="{{ route('communities.index') }}" class="flex flex-col items-center justify-center gap-0.5 {{ request()->is('communities') || request()->is('community*') ? 'text-teal-600 dark:text-teal-400' : 'text-gray-500 dark:text-gray-400' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
            <span class="text-[10px] font-medium leading-none">Communities</span>
        </a>
